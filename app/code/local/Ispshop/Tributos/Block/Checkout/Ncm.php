...
class Ispshop_Tributos_Block_Checkout_Ncm extends Mage_Checkout_Block_Cart_Abstract {
    ...
    public function getSaveConsumptiontUrl() {
        return Mage::getUrl('ispshop_tributos/customer_checkout/saveConsumptionMethod');
    }
