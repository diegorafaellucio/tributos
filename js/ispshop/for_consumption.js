IspshopOnestepcheckoutForConsumption = Class.create();
IspshopOnestepcheckoutForConsumption.prototype = {
    ...
    switchToMethod: function (methodCode) {
        if (this.currentMethod !== methodCode) {
            IspshopOnestepcheckoutCore.updater.startRequest(this.saveShipmentUrl, {
                method: 'post',
