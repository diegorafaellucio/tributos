var IspshopOnestepcheckoutCore = {
    initialize: function() {
...
var AWOnestepcheckoutCoreUpdater = {
    ...
    addActionBlocksToQueue: function(action) {
        ...
        this.map[action].each(function(blockName){
            ...
            if (me.queue[blockName] === 0) {
                ...
                IspshopOnestepcheckoutCore.addLoaderOnBlock(targetBlockForAddLoader, me.loaderConfig);
    ...
    removeActionBlocksFromQueue: function(action, response) {
        ...
        this.map[action].each(function(blockName){
            ...
            if (me.queue[blockName] === 0) {
                ...
                IspshopOnestepcheckoutCore.removeLoaderFromBlock(me.blocks[blockName], me.loaderConfig);
    ...
    _getActionFromUrl: function(url) {
        var matches = url.match(/ispshop_tributos\/customer_ajax\/([^\/]+)\//);
...
IspshopOnestepcheckoutCore.initialize();
...
AWOnestepcheckoutHelperTimer.prototype = {
    ...
    onTimerRedirectElClick: function(e) {
        ...
        //add loader css
        var cssClassName = IspshopOnestepcheckoutCore.getCssLoaderClassForBlock(this.container, this.overlayConfig);
        if (cssClassName) {
